function [users,items1,items2,indx]=Sampler_LP(numSamples,R,row,col,xadj,adj,deg,...
    byuser,uniformsampling)

% algorithm based on popularity (sample the least popular items)
% Imbalanced-least Popular-sampling
